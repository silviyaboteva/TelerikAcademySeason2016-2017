...
//         ctx = canvas.getContext("2d"), //webgl - three.js search it
//         isMouthOpen = false,
//         pacman = {
//             "x": 50,
//             "y": 50,
...
//     //30 degree * PI / 180 degree = RADIANS
//     function gameLoop() {
...
//         ctx.beginPath();
//         var x = ballToDraw.x + ball.size/2;
//         var y = ballToDraw.y + ball.size/2;
//         var size = ballToDraw.size/2;
//         ctx.arc(ballToDraw.x, ballToDraw.y, ballToDraw.size, 0, 2 * Math.PI);
//         ctx.fill();
//     }
